      ...
      <form method="post" action="">
          <div class="mb-3 text-start">
              ...
              <div class="input-group">
                  ...
                  <input type="email" class="form-control" id="email" name="email" required aria-describedby="basic-addon1">
              </div>
          </div>
          ...
          <div class="mb-3 text-start">
              ...
              <div class="input-group">
                  ...
                  <input type="password" class="form-control" id="senha" name="senha" required aria-describedby="basic-addon2">
              </div>
          </div>
